...
# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File: corpus-label-classification -> word2vec_dynamic
@IDE    : PyCharm
@Author : fengchengli
            ...
            for file in files:
                ...
                if file_path[-3:] == 'txt':
                    with open(file_path, 'r', encoding='utf-8') as f:
                        texts = list(map(lambda x: list(jieba.cut(re.sub("[0-9]{4,}|[！，。？、~@#￥%&*（）.,:：|/`()_;+；…\\\\\\-\\s]", "", x))), f.readlines()))
...
def main(unused_argv):
    ...
    word2vec_basic(os.path.join(home_dir, 'bert_classify/model/word2vec'))
